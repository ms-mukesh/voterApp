                        ...
                        <View style={{flex: 1, flexDirection: 'row'}}>
                            ...
                            <View style={{flex: 1, justifyContent: 'space-between'}}>
                                ...
                                <View style={{flexDirection:'row',flex:1,justifyContent: 'space-between'}}>
                                    ...
                                    <View style={{alignItems:'center',justifyContent:'center',height:hp(5),width:(IsIOSOS || IsAndroidOS)?wp(40):wp(20),borderRadius:hp(1.5),backgroundColor:color.lightGreen}}>
