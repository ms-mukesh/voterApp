            ...
            <View style={{flex: 1,}}>
                <View style={{flex:1,flexDirection:'row'}}>
                    ...
                    <TouchableWithoutFeedback onPress={()=>{
                        ...
                        closeFamilyModal()
                    }} style={{width:wp(30),alignItems:'center',justifyContent:'center'}}>
                       <View style={{alignItems:'center',justifyContent:'center',backgroundColor:color.themePurple,borderRadius:wp(1.5),height:hp(5),width:wp(12),alignSelf:'center',justifySelf:'center'}}>
     ...
     return (
        <Modal onRequestClose={() => closeModal!==null &&closeModal()} visible={true} animated={true} transparent={false}>
            <SafeAreaView style={{flex:1,padding:hp(1),backgroundColor:'white'}}>
                ...
                <Text style={{marginLeft:wp(30),textAlign:'center',width:wp(45),fontSize:normalize(20),fontWeight:'800',color:color.themePurple}}>SELECT FAMILY</Text>
                <Text onPress={()=>{
                    closeFamilyModal()
...
const styles = StyleSheet.create({
    ...
    ListHeader:{fontWeight:'600',fontSize:normalize(13),color:color.themePurple},
    ListItems:{marginLeft:wp(2),width:wp(58),fontWeight:'400',fontSize:normalize(11),color:color.black},
    subfontStyle: {
        fontSize: normalize(10),
        // fontFamily: font.robotoBold,
        textAlign: 'center',
